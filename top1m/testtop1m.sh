...
function scan_host() {
    ...
    ../cipherscan --capath ca_files --saveca --savecrt certs -json -servername $1 $2:443 > results/$1@$2
}
...
function scan_host_no_sni() {
    ...
    ../cipherscan --capath ca_files --saveca --savecrt certs -json $1:443 > results/$1
}
